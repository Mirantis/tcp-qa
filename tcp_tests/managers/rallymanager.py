...
#        self._docker_exec(cmd)
    ...
    def run_tempest(self, conf_name='/var/lib/lvm_mcp.conf',
        ...
        :param report_prefix: prefix for report filenames. Usually the output
                              of the fixture 'func_name' to match the testcase
