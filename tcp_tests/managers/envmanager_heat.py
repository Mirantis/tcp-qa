...
class EnvironmentManagerHeat(object):
    ...
    def _nodes(self):
        ...
        for heat_node in self._get_resources_by_type("OS::Nova::Server"):
            ...
            #   {'admin_pool01': <floating_ip1>,
            #    'private_pool01': <floating_ip2>,
            #    'external_pool01': <floating_ip3>
            #   }
            ...
            nodes.append({
                ...
                #'roles': heat_node.description.split(','),
...
# TODO(ddmitriev): add all Environment methods
    @staticmethod
    def node_ip(node, address_pool_name='admin_pool01'):
        """Determine node's IP
