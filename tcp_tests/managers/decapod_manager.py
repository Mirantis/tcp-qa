...
class DecapodManager(ExecuteCommandsMixin):
    ...
    def __init__(self, config, underlay, salt=None):
        ...
        self.decapod_nodes = [
            ...
            if ext.UNDERLAY_NODE_ROLES.decapod_mon in i['roles'] or
            if ext.UNDERLAY_NODE_ROLES.decapod_osd in i['roles'] or
            if ext.UNDERLAY_NODE_ROLES.decapod_all in i['roles']]
