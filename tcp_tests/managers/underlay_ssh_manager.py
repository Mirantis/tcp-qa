...
class UnderlaySSHManager(object):
    ...
    def get_logs(self, artifact_name,
        ...
        dump_commands = (
            ...
            "docker service ls > /root/$(hostname -f)/dump_docker_services_ls.txt;"
            "docker service ls | grep ' 0' | awk '${print $2}' | xargs -I {} docker service logs 2>&1 {} > dump_{}_docker_service.txt;"
