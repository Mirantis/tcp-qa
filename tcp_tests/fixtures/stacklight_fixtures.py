...
@pytest.fixture(scope='function')
def sl_v1_actions(config, underlay, salt_deployed, openstack_deployed):
    """Fixture that provides various actions for K8S
...
@pytest.fixture(scope='function')
def sl_v1_upgrade_actions(config, underlay, salt_deployed, openstack_deployed, sl_v1_deployed):
    """Fixture that provides various actions for K8S
    ...
    For use in tests or fixtures to deploy a custom K8S
    """
    return sl_manager.SLManager(config, underlay, salt_deployed, sl_v1_deployed)
