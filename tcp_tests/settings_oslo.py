...
k8s_deploy_opts = [
    ...
    ct.Cfg('kubernetes_criproxy_version', ct.String(),
           help="", default='v0.11.0'),
    ct.Cfg('kubernetes_criproxy_checksum', ct.String(),
           help="", default='115bbb0c27518db6b0b3bc8cdc5fc897'),
