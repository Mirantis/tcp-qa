...
export ENV_NAME=multiserver_ha
...
export LAB_CONFIG_NAME=multiserver_ha
export CLUSTER_NAME=multiserver_ha
...
export SALT_MODELS_SYSTEM_REPOSITORY=http://gerrit.mirantis.local.test/ericsson-mcp-enablement-program/micro-model
