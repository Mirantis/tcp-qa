...
export ENV_NAME=eee-local-ocata-ovs-ceph
...
export LAB_CONFIG_NAME=eee-local-ocata-ovs-ceph
export CLUSTER_NAME=virtual-mcp-ocata-ovs-ceph-local-eee
export REPOSITORY_SUITE=stable

export TEST_GROUP=test_ocata_ceph_all_ovs_install

# Offline deploy parameters
export SALT_MODELS_REF_CHANGE=refs/changes/86/13886/5
