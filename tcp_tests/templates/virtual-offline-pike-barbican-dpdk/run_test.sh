...
export ENV_NAME=virtual-offline-pike-barbican-dpdk
...
export LAB_CONFIG_NAME=virtual-offline-pike-barbican-dpdk
export CLUSTER_NAME=virtual-offline-pike-barbican-dpdk
