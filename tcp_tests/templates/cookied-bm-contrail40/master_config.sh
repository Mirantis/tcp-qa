...
export SALT_MASTER_DEPLOY_IP=172.16.49.66
export SALT_MASTER_MINION_ID=cfg01.cookied-bm-contrail40.local
export DEPLOY_NETWORK_GW=172.16.49.126
export DEPLOY_NETWORK_NETMASK=255.255.255.192
export DNS_SERVERS=172.18.208.44
export http_proxy=
export https_proxy=
export PIPELINES_FROM_ISO=false
