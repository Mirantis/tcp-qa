...
class TestFailover(object):
    ...
    def test_kill_influxdb_relay_mon01_node(self, underlay,
        ...
        # STEP #7
        show_step(7)
        assert '777' in sl_deployed.check_data_in_influxdb('mon02')
        assert '777' in sl_deployed.check_data_in_influxdb('mon03')
        # STEP #8
        show_step(8)
        sl_deployed.start_service('mon01', 'influxdb-relay')
        # STEP #9
        show_step(9)
        assert '777' in sl_deployed.check_data_in_influxdb('mon01')
        # STEP #10
        show_step(10)
        after_result = sl_deployed.run_sl_tests_json(
            'cfg01', '/root/stacklight-pytest/stacklight_tests/',
