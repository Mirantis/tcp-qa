...
class TestFailover(object):
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_stop_influxdb_relay_mon01_node(self, underlay,
                                            openstack_deployed,
                                            openstack_actions,
                                            sl_deployed,
                                            show_step):
        ...
        Scenario:
            ...
            3. Setup compute, monitoring nodes
            4. Check LMA before mon node shutdown
            5. Stop influxdb relay on mon01 node
            6. Run LMA tests after failover
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_stop_influxdb_mon01_node(self, underlay,
                                      openstack_deployed,
                                      openstack_actions,
                                      sl_deployed,
                                      show_step):
