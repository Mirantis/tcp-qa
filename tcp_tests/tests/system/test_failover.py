...
class TestFailover(object):
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_restart_mon01_node(self, sl_openstack_deployed,
                                openstack_actions, show_step):
        """Test restart mon01
        ...
        # STEP #4
        show_step(4)
        mon_nodes = sl_openstack_deployed.get_monitoring_nodes()
        LOG.debug('Mon nodes list {0}'.format(mon_nodes))
        sl_openstack_deployed.check_prometheus_targets(mon_nodes)
        before_result = sl_openstack_deployed.run_sl_tests_json(
        ...
        after_result = sl_openstack_deployed.run_sl_tests_json(
            'cfg01', '/root/stacklight-pytest/stacklight_tests/',
            'tests/prometheus/', 'test_alerts.py')
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_kill_influxdb_relay_mon01_node(self, sl_openstack_deployed,
                                            show_step):
        ...
        # STEP #5
        show_step(5)
        sl_openstack_deployed.kill_sl_service_on_node('mon01', 'influxdb-relay')

        # STEP #6
        show_step(6)
        sl_openstack_deployed.post_data_into_influx('mon02')

        # STEP #7
        show_step(7)
        assert 'mymeas' in sl_openstack_deployed.check_data_in_influxdb('mon02')
        assert 'mymeas' in sl_openstack_deployed.check_data_in_influxdb('mon03')

        # STEP #8
        show_step(8)
        sl_openstack_deployed.start_service('mon01', 'influxdb-relay')

        # STEP #9
        show_step(9)
        assert 'mymeas' in sl_openstack_deployed.check_data_in_influxdb('mon01')
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_kill_influxdb_mon01_node(self, sl_openstack_deployed, show_step):
        ...
        # STEP #5
        show_step(5)
        sl_openstack_deployed.kill_sl_service_on_node('mon01', 'influxd')
        ...
        # STEP #8
        show_step(8)
        sl_openstack_deployed.start_service('mon01', 'influxd')

        # STEP #9
        show_step(9)
        self.check_influxdb_xfail(sl_openstack_deployed, 'mon01', 'mymeas')
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_stop_influxdb_relay_mon_nodes(self, sl_openstack_deployed,
                                           show_step):
        ...
        # STEP #5
        show_step(5)
        sl_openstack_deployed.stop_sl_service_on_node('mon01', 'influxdb-relay')
        sl_openstack_deployed.stop_sl_service_on_node('mon02', 'influxdb-relay')

        # STEP #6
        show_step(6)
        sl_openstack_deployed.post_data_into_influx('mon03')
        ...
        show_step(8)
        sl_openstack_deployed.start_service('mon01', 'influxdb-relay')
        sl_openstack_deployed.start_service('mon02', 'influxdb-relay')
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_stop_influxdb_mon_nodes(self, sl_openstack_deployed, show_step):
        ...
        # STEP #5
        show_step(5)
        sl_openstack_deployed.stop_sl_service_on_node('mon01', 'influxdb')
        sl_openstack_deployed.stop_sl_service_on_node('mon02', 'influxdb')
        ...
        # STEP #8
        show_step(8)
        sl_openstack_deployed.start_service('mon01', 'influxdb')
        sl_openstack_deployed.start_service('mon02', 'influxdb')

        # STEP #9
        show_step(9)
        self.check_influxdb_xfail(sl_openstack_deployed, 'mon01', 'mymeas')
        self.check_influxdb_xfail(sl_openstack_deployed, 'mon02', 'mymeas')
