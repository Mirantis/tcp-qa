...
def get_control_plane_targets():
    ...
    LOG.info(saltmanager.get_single_pillar("I@salt:master",
    ...
    x = saltmanager.get_single_pillar("I@salt:master",
                                          "_param:barbican_enabled")
    LOG.info("_param:barbican_enabled: {} type {}".format(x, type(x)))
    if saltmanager.get_single_pillar("I@salt:master",
