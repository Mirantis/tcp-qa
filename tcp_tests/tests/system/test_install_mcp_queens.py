...
class TestMcpInstallQueensCeph(object):
    ...
    @pytest.mark.queens_dvr_os_ceph
    def test_mcp_queens_dvr_ceph_install(self, underlay,
                                         openstack_deployed,
                                         tempest_actions):
...
class TestMcpInstallQueensOvs(object):
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    @pytest.mark.queens_ovs
    def test_mcp_queens_ovs_install(self, underlay,
                                    openstack_deployed,
                                    stacklight_deployed,
                                    tempest_actions):
        """Test for deploying an mcp environment and check it
    ...
    @pytest.mark.fail_snapshot
    @pytest.mark.queens_ovs
    def test_mcp_queens_ovs_sl_install(self, underlay,
                                       openstack_deployed,
                                       stacklight_deployed):
        """Test for deploying an mcp environment and check it
        Scenario:
...
class TestMcpInstallQueensDvr(object):
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    @pytest.mark.queens_dvr
    def test_mcp_queens_dvr_install(self, underlay,
                                    openstack_deployed,
                                    stacklight_deployed,
                                    tempest_actions):
        """Test for deploying an mcp environment and check it
    ...
    @pytest.mark.fail_snapshot
    @pytest.mark.queens_dvr
    def test_mcp_queens_dvr_sl_install(self, underlay,
                                       openstack_deployed,
                                       stacklight_deployed):
        """Test for deploying an mcp environment and check it
        Scenario:
...
class TestMcpInstallQueensDvrSsl(object):
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    @pytest.mark.queens_dvr_ssl
    def test_mcp_queens_dvr_ssl_install(self, underlay,
                                        openstack_deployed,
                                        stacklight_deployed,
                                        tempest_actions):
        """Test for deploying an mcp environment and check it
    ...
    @pytest.mark.fail_snapshot
    @pytest.mark.queens_dvr_ssl
    def test_mcp_queens_dvr_ssl_sl_install(self, underlay,
                                           openstack_deployed,
                                           stacklight_deployed):
        """Test for deploying an mcp environment and check it
        Scenario:
