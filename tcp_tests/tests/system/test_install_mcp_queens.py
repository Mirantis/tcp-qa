...
@pytest.mark.deploy
class TestMcpInstallQueens(object):
    """Test class for testing mcp queens deploy"""

    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    @pytest.mark.queens_os
    def test_mcp_queens_install(self, underlay,
                                openstack_deployed,
                                openstack_actions,
                                tempest_actions):
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    @pytest.mark.queens_os_sl
    def test_mcp_queens_sl_install(self, underlay, config,
                                   openstack_deployed,
                                   stacklight_deployed):
        """Test for deploying an mcp environment and check it
        Scenario:
