...
class TestBackupRestoreCassandra(object):
    ...
    def test_backup_restore_cassandra(self, salt_actions, reclass_actions,
        ...
        #
        # show_step(1)
        # reclass.add_bool_key("parameters.cassandra.backup.enabled",
        #                      "True",
        #                      "cluster/*/infra/backup/server.yml")
        # reclass.add_key("parameters.cassandra.backup.hours_before_full",
        #                 "24",
        #                 "cluster/*/infra/backup/server.yml")
        # reclass.add_key(
        #     "parameters.cassandra.backup.full_backups_to_keep",
        #     "5",
        #     "cluster/*/infra/backup/server.yml")
        ...
        # reclass.add_key("parameters.cassandra.backup_dir",
