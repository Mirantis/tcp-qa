...
class TestBackupRestoreCassandra(object):
    ...
    def test_backup_creation(self, salt_actions, show_step, _):
    ...
    def test_restore_automatic(self, salt_actions, reclass_actions,
        ...
        show_step(2)
        self.test_backup_creation(self, salt_actions, show_step,
                                  underlay_actions, _)
        show_step(3)
        reclass.add_class(
    ...
    #                                reclass_actions,
    #                                show_step, underlay_actions, _,
    #                                create_backup, handle_restore_params):
