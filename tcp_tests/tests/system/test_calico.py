...
class TestMCPCalico(object):
    ...
    def test_k8s_netchecker_calico(self, show_step, config, k8s_deployed):
        """Test for deploying k8s environment with Calico plugin and check
           network connectivity different between pods
        ...
        netchecker.wait_running(k8sclient, timeout=240)
    ...
    def test_calico_route_recovery(self, show_step, config, underlay,
        ...
        first_node_ip = first_node_ips[0]
        target_pod_ip = None
        ...
        underlay.sudo_check_call(cmd=route_del_cmd, host=first_node_ip)
        ...
        underlay.sudo_check_call(cmd=pod_ping_cmd, host=first_node_ip)
    ...
    def test_calico_network_policies(self, show_step, config, underlay,
        ...
        Scenario:
            ...
            4. Check that netchecker-server returns 400: 'There are no pods'
        ...
        netchecker.wait_running(k8sclient, namespace='netchecker', timeout=240)
