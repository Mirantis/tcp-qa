...
class TestBackupRestoreGalera(object):
    ...
    def test_backup_restore_galera(self, salt_actions, show_step, _):
        ...
        job_cvp_sanity_parameters = {
            ...
            '''.format('python-setuptools','python-pkg-resources,xunitmerge',
                    'python-gnocchiclient', 'python-ujson','python-octaviaclient',
                    'test_ceph_status', 'test_prometheus_alert_count', 'test_uncommited_changes')
        }
