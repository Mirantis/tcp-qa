    ...
    def test_backup_restore_galera(self, salt_actions, show_step, _):
        ...
        job_parameters = {
         'EXTRA_PARAMS': '''
                ...
                envs:
                  - skipped_packages='python-setuptools,python-pkg-resources,xunitmerge,python-gnocchiclient, python-ujson,python-octaviaclient'
                  - skipped_modules='xunitmerge,setuptools'
                  - skipped_services='docker,containerd'
                  - ntp_skipped_nodes=''
                  - tests_set=-k "not test_ceph_status and not test_prometheus_alert_count and not test_uncommited_changes"
         '''
        }
