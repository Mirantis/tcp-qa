...
class TestFailoverK8s(object):
    ...
    def test_k8s_master_vip_reboot(self, show_step, k8s_deployed,
        ...
        k8s_actions.shutdown_node(
            k8s_actions.get_node_name_by_subname(minion_vip)[0],
        ...
        show_step(8)
        k8s_actions.shutdown_node(
            k8s_actions.get_node_name_by_subname(new_minion_vip)[0],
