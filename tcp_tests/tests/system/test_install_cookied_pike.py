...
@pytest.mark.deploy
class TestMcpCoockiedInstall(object):
    """Test class for testing mcp Pike vxlan deploy"""

    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_cookied_pike_ovs_install(self, underlay, openstack_deployed,
                                      show_step):
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_cookied_pike_dvr_install(self, underlay, openstack_deployed,
                                      show_step):
        """Test for deploying an mcp pike environment and check it
        Scenario:
        1. Prepare salt on hosts
        2. Setup controller nodes
        3. Setup compute nodes
    ...
    @pytest.mark.grab_versions
    @pytest.mark.fail_snapshot
    def test_cookied_pike_cicd_oss_install(self, underlay, openstack_deployed,
