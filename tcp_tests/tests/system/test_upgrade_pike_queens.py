...
class TestUpdatePikeToQueens(object):
    ...
    def test_upgrade_pike_queens(self, show_step, hardware, underlay,
                                 day1_cfg_config):
        ...
        cfg_node = underlay.get_target_node_names(
            target='cfg')[0]
        ...
        for i in ['nova-manage', 'cinder-manage']:
            underlay.check_call(
                ...
                cmd="salt ctl01* cmd.run {} db online_data_migrations".format(i))
