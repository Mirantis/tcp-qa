...
//        def dhcp_ranges = new groovy.json.JsonSlurper().parseText(dhcp_ranges_json)
        def dhcp_ranges = new groovy.json.JsonSlurper
//        def ADMIN_NETWORK_GW1 = dhcp_ranges['admin-pool01']['gateway']
//        println("dhcp_ranges_json=${dhcp_ranges_json}")
//        println("dhcp_ranges=${dhcp_ranges}")
//        println("ADMIN_NETWORK_GW1=" + ADMIN_NETWORK_GW1)
        def ADMIN_NETWORK_GW = "10.70.1.1"
