...
def swarm_deploy_cicd(stack_to_install='core,cicd') {
...
def swarm_deploy_stacks(String stack_to_install) {
        ...
        common.printMsg("Start building job 'swarm-deploy-stacks' with parameters:", "purple")
        common.prettyPrint(parameters)
        build job: 'swarm-deploy-stacks',
            parameters: parameters
}
