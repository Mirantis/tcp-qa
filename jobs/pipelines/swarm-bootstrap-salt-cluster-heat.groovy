           ...
           usernameVariable: 'OS_USERNAME']
            ...
            stage("Upload cfg01-day01 and VCP images") {
                shared.run_cmd("""\
                    ...
                    openstack --insecure image show cfg01-day01-${MCP_VERSION} -f value -c name || openstack --insecure image create cfg01-day01-${MCP_VERSION} --file ${IMAGE_PATH_CFG01_DAY01} --disk-format qcow2 --container-format bare
                    openstack --insecure image show ubuntu-vcp-${MCP_VERSION} -f value -c name || openstack --insecure image create ubuntu-vcp-${MCP_VERSION} --file ${MCP_IMAGE_PATH1604} --disk-format qcow2 --container-format bare
                """)
            }
...
//                """)
        ...
        withCredentials([
           ...
           passwordVariable: 'JENKINS_USER',
           usernameVariable: 'JENKINS_PASS']
        ]) {
                ...
                """)
                shared.verbose_sh(script, true, false, true)
