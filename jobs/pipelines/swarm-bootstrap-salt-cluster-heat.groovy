    ...
    dir("${PARENT_WORKSPACE}") {
        ...
        withCredentials([
           ...
           usernameVariable: 'JENKINS_USER']
                ...
                jenkins_agent_description = "ssh jenkins@${jenkins_slave_ip}  # foundation node with Jenkins agent ${JENKINS_URL}/computer/${JENKINS_SLAVE_NODE_NAME}<br>ssh root@${SALT_MASTER_IP}  # cfg01 node<br>"
