...
node (node_name) {
  ...
  timestamps(){
    ...
    stage("Prepare arguments for generation config drive") {
        ...
        def config_drive_script_path = "mcp-common-scripts-git/config-drive/create_config_drive.sh"
        def user_data_script_path = "mcp-common-scripts-git/config-drive/master_config.yaml"
